...
import { medicalRecodHostoData } from '../../components/Datas';
import MedicalRecodHostoModal from '../../components/Modals/MedicalRecodHostoModal';
import { useNavigate } from 'react-router-dom';

const MedicalHostoRecord = () => {
      ...
      <div className="flex-btn gap-4">
        ...
        <div className="sm:w-1/4 w-full">
          <Button
            ...
            Icon={BiPlus}
            onClick={() => {
              navigate(`/hosto/visiting/1`);
            }}
          />
        </div>
      </div>
      {medicalRecodHostoData.map((data) => (
        <div
          key={data.id}
...
export default MedicalHostoRecord