...
const NewMarternite = () => {
  ...
  return (
    <Layout>
        ...
        <div className="items-center pl-8 gap-4">
          <h1 className="text-xl font-semibold">New Marternite Record</h1>
        </div>
          ...
          >
            <div className="flex w-full flex-col gap-5">
              ...
              <div className="flex w-full flex-col gap-4">
                <p className="text-black text-sm">I.ADMISSION</p>
              ...
              {/* attachment */}
              <div className="flex w-full flex-col gap-4">
                <p className="text-black text-sm">II.Surveillance De La Phase De Latence inférieur à 4cm </p>
                <div className="grid xs:grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 w-full">
                  {[1, 2, 3, 4].map((_, i) => (
                    <div className="relative w-full">
                      <img
              ...
              {/* attachment */}
              <div className="flex w-full flex-col gap-4">
                <p className="text-black text-sm">III.Surveillance De La Phase active supérieur ou égal à 4cm</p>
                <div className="grid xs:grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 w-full">
                  {[1, 2, 3, 4].map((_, i) => (
                    <div className="relative w-full">
                      <img
              ...
              {/* attachment */}
              <div className="flex w-full flex-col gap-4">
                <p className="text-black text-sm">IV.Accouchement</p>
                <div className="grid xs:grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 w-full">
                  {[1, 2, 3, 4].map((_, i) => (
                    <div className="relative w-full">
                      <img
              ...
              {/* attachment */}
              <div className="flex w-full flex-col gap-4">
                <p className="text-black text-sm">V.Surveillance Post-partum Immédiat et Tardif</p>
                <div className="grid xs:grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 w-full">
                  {[1, 2, 3, 4].map((_, i) => (
                    <div className="relative w-full">
                      <img
